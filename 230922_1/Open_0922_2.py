...
gray2gray = cv2.imread("C:/Users/OWNER/Desktop/read_gray.jpg", cv2.IMREAD_GRAYSCALE)
gray2color = cv2.imread("C:/Users/OWNER/Desktop/read_gray.jpg", cv2.IMREAD_COLOR)
