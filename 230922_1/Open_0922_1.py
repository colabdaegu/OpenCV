...
gray2gray = cv2.imread("C:/Users/USER/Desktop/read_gray.jpg", cv2.IMREAD_GRAYSCALE) ## 회색 처리
gray2color = cv2.imread("C:/Users/USER/Desktop/read_gray.jpg", cv2.IMREAD_COLOR)    ## 컬러 처리
